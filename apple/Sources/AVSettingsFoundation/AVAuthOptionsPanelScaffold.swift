    ...
    public var body: some View {
        VStack(spacing: 0) {
            RoundedRectangle(cornerRadius: 2, style: .continuous)
                .fill(AVBrandColor.brandGraphite.opacity(0.22))
            ...
            if let unavailableMessage {
                Text(unavailableMessage)
                    ...
                    .foregroundStyle(AVBrandColor.brandGraphite.opacity(0.7))
                    .multilineTextAlignment(.center)
                    .padding(.top, 12)
            }
            ...
            Button(skipTitle, action: onSkip)
                ...
                .foregroundStyle(AVBrandColor.brandGraphite.opacity(0.82))
                .padding(.top, 16)

            Text(legalConsentText)
                .font(.system(size: 12, weight: .medium))
                .foregroundStyle(AVBrandColor.brandGraphite.opacity(0.66))
                .tint(AVBrandColor.brandGraphite.opacity(0.9))
                .multilineTextAlignment(.center)
                .padding(.top, 14)
        }
        ...
        .background(
            RoundedRectangle(cornerRadius: 30, style: .continuous)
                ...
                .overlay {
                    RoundedRectangle(cornerRadius: 30, style: .continuous)
                        .stroke(AVBrandColor.brandGraphite.opacity(0.12), lineWidth: 1)
                }
